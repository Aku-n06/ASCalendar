...
class ASBodyContainerV: UIView {
    ...
    func mainViewInit() {
        ...
        let subviewArray = NSBundle.mainBundle().loadNibNamed("ASBodyV", owner: self, options: nil)
        self.view = subviewArray.first as! ASBodyV
